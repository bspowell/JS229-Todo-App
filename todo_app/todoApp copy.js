...
class Todo {
  ...
  isWithinMonth(month) {
    return this.month === month.toString();
  }
  isWithinYear(year) {
...
class TodoManager {
  ...
  todosMonth(month) {
    return this.todoList.filter(todo => {
      return todo.isWithinMonth(month);
    })
  }
  todosYear(year) {
    return this.todoList.filter(todo => {
      return todo.isWithinYear(year);
    })
  }
  ...
  completedTodosMonth(month) {
    return this.todoList.filter(todo => {
      return todo.isWithinMonth(month) && todo.completed;
    })
  }
  completedTodosYear(year) {
    return this.todoList.filter(todo => {
      return todo.isWithinYear(year) && todo.completed;
    })
  }
}
